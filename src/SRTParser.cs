...
public class SRTParser
{
    ...
    public SubtitleBlock GetForTime(double timeSecond)
    {
        if (timeSecond < _subtitles[_subtitles.Count - 1].To)
        {
            var subtitle = _subtitles.Find(x => (x.From < timeSecond && timeSecond < x.To));
